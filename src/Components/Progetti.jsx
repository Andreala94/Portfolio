    ...
    return (
      ...
      <Row>
        ...
        <a href="https://github.com/Andreala94" target="_blank" rel="noopener noreferrer" onClick={openGitHub}>
          ...
          <p className='mt-2'>Profilo GhitHub</p>
        </Col>
        ...
        <p className='mt-2'>Sito Eventi in Puglia dove un utente può controllare che eventi ci sono in puglia,
        ...
        <Col xs={12} md={6}>
          ...
          <p className='mt-2'>Interfaccia replica Netflix creata  in HTML e CSS</p>
        </Col>
      </Row>
    </Container>
